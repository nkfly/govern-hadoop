...
if __name__ == '__main__':
	...
	# pid2sales = get_pid2sales('./order.csv')
	...
	for pid in pid2viewSum:
		...
		x = [viewSum, uniqueViewer, searchSum, uniqueSearch, price]
		...
		if pid in trainPid2sales and pid in pid2price:
			buyCount = int(trainPid2sales[pid]/pid2price[pid])
		else:
			buyCount = 0
		y.append(buyCount)
	...
	predictions = clf.predict(predictX)

	index = 0
	with open('final_result_final_addcat', 'w') as w:
		for pid in pid2viewSum:
